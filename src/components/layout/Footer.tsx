/**
 * Footer Component
 * Comprehensive site footer with links, newsletter, and social icons.
 */
...
export default function Footer() {
  ...
  const serviceLinks = [
    { href: '/services/custom-software-development', label: locale === 'ar' ? 'تطوير البرمجيات' : 'Software Development' },
    { href: '/services/cloud-infrastructure', label: locale === 'ar' ? 'البنية السحابية' : 'Cloud Infrastructure' },
    { href: '/services/cybersecurity', label: locale === 'ar' ? 'الأمن السيبراني' : 'Cybersecurity' },
    { href: '/services/data-analytics', label: locale === 'ar' ? 'تحليلات البيانات' : 'Data Analytics' },
  ];

  const legalLinks = [
    { href: '/legal', label: locale === 'ar' ? 'الحلول القانونية' : 'Legal Solutions' },
    { href: '/legal/product', label: locale === 'ar' ? 'ليجال إيدج برو' : 'LegalEdge Pro' },
      ...
      <div className="border-t border-neutral-800">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-neutral-500">
            &copy; {new Date().getFullYear()} {siteConfig.name[locale]}. {t('copyright')}
          </p>
